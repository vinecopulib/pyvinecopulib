...
- `EmpiricalMargin.sample` works instead of raising `NotImplementedError`, resampling observed values as its documentation already described. Only the standalone call was affected; `Vinedist.sample` goes through `marginal_icdf` (#292).
