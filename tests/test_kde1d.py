...
def test_kde1d_factory_methods() -> None:
  ...
  kde_from_grid = pv.core.Kde1d.from_grid(
...
def test_kde1d_string_representation() -> None:
  ...
  assert "<pyvinecopulib.core.Kde1d>" in repr_str
  assert "<pyvinecopulib.core.Kde1d>" in str_str
