...
OPTION(PYVINECOPULIB_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
IF(PYVINECOPULIB_USE_KWSTYLE)
...
SET(KWSTYLE_CONFIGURATION_FILE 
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/PYVINECOPULIBKWS.xml)

SET(KWSTYLE_PYVINECOPULIB_FILES_LIST
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/PYVINECOPULIBFiles.txt)

SET(KWSTYLE_PYVINECOPULIB_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/PYVINECOPULIBOverwrite.txt )

#
# Configure the files
#
CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/PYVINECOPULIBFiles.txt.in
  ${KWSTYLE_PYVINECOPULIB_FILES_LIST})

CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/PYVINECOPULIBKWS.xml.in
...
SET(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_PYVINECOPULIB_FILES_LIST}
  -o ${KWSTYLE_PYVINECOPULIB_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

ADD_CUSTOM_COMMAND(
  OUTPUT  ${PYVINECOPULIB_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

ADD_CUSTOM_TARGET(StyleCheckCode DEPENDS ${PYVINECOPULIB_BINARY_DIR}/KWStyleCodeReport.txt)

ADD_TEST(KWStyle ${KWSTYLE_EXECUTABLE} ${KWSTYLE_ARGUMENTS_CODE})

ENDIF(KWSTYLE_FOUND)
ENDIF(KWSTYLE_EXECUTABLE)
ENDIF(PYVINECOPULIB_USE_KWSTYLE)
