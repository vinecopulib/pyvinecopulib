...
R"""(Checks whether the supplied rotation is valid (only 0, 90, 180, 270 allowd).)""";
      ...
      struct /* check_var_types */ {
        // Source: vinecopulib/bicop/implementation/class.ipp:1083
        const char* doc =
R"""(Checks whether var_types have the correct length and are either "c" or "d".)""";
      ...
      struct /* check_weights_size */ {
        // Source: vinecopulib/bicop/implementation/class.ipp:1062
        const char* doc =
...
R"""(Adjusts the copula model to a change in the variable order.)""";
      ...
      struct /* format_data */ {
        // Source: vinecopulib/bicop/implementation/class.ipp:969
        const char* doc =
...
R"""(Gets the modified bic (only for fitted objects).)""";
      ...
      struct /* get_n_discrete */ {
        // Source: vinecopulib/bicop/implementation/class.ipp:1097
        const char* doc =
...
A length n vector of copula densities evaluated at ``u``.)""";
      ...
      struct /* prep_for_abstract */ {
        // Source: vinecopulib/bicop/implementation/class.ipp:1034
        const char* doc =
...
rotate the data appropriately (``AbstractBicop`` is always 0deg-rotation).)""";
      ...
      struct /* rotate_data */ {
        // Source: vinecopulib/bicop/implementation/class.ipp:998
        const char* doc =
...
config :
    The configuration object.)""";
        ...
        const char* doc_11args_family_set_parametric_method_nonparametric_method_nonparametric_mult_nonparametric_grid_size_selection_criterion_weights_psi0_preselect_families_allow_rotations_num_threads =
...
selection_criterion :
    The selection criterion (``"loglik"``, ``"aic"``, ``"bic"``, ``"mbic"``, or ``"mbicv"``) for the
...
num_threads :
    ...
    more than the number of concurrent threads supported by the implementation.)""";
        ...
        const char* doc_3args_nonparametric_method_nonparametric_mult_nonparametric_grid_size =
...
R"""(Whether to show a trace of the building progress. Default: false.)""";
      ...
      struct /* threshold */ {
        ...
        const char* doc =
R"""(Threshold for thresholded vines. Default: 0.)""";
      } threshold;
...
alternative :
    ...
    association. For Hoeffding's :math:`D`, only ``"two-sided"`` is allowed.)""";
      ...
      struct /* alternative */ {
        // Source: wdm.hpp:114
        const char* doc =
R"""(the alternative hypothesis used for the test)""";
      } alternative;
