...
PYBIND11_MODULE(pyvinecopulib, pv)
{
  ...
  py::class_<RVineStructure>(pv, "RVineStructure")
    ...
    .def("to_json",
         ...
         "writes the file in a JSON file.",
         py::arg("filename"))
  ...
  py::class_<Vinecop>(pv, "Vinecop")
    ...
    .def(py::init<const std::vector<std::vector<Bicop>>&,
                  ...
                  const bool>(),
         "creates a vine copula with structure specified by an R-vine "
         "structure; all pair-copulas are set to independence.",
         py::arg("pair_copulas"),
         py::arg("vine_struct"),
         py::arg("check"))
    .def(py::init<const std::vector<std::vector<Bicop>>&,
                  ...
                  const bool>(),
         "creates a vine copula with structure specified by an R-vine "
         "matrix; all pair-copulas are set to independence.",
         py::arg("pair_copulas"),
         py::arg("matrix"),
         py::arg("check"))
    .def(py::init<const std::string>(),
