...
class Kde1d:
  ...
  """
  def __init__(self, xmin: float | None = None, xmax: float | None = None, type: str = 'continuous', multiplier: float = 1.0, bandwidth: float | None = None, degree: int = 2, grid_size: int = 400) -> None:
    """
  ...
  @staticmethod
  def from_grid(grid_points: ArrayLike, values: ArrayLike, xmin: float | None = None, xmax: float | None = None, type: str = 'continuous', prob0: float = 0.0) -> "Kde1d":
    """
  ...
  @staticmethod
  def from_params(xmin: float | None = None, xmax: float | None = None, type: str = 'continuous', multiplier: float = 1.0, bandwidth: float | None = None, degree: int = 2, grid_size: int = 400) -> "Kde1d":
    """
  ...
  def plot(self, xlim: object | None = None, ylim: object | None = None, grid_size: int = 200, show_zero_mass: bool = True) -> None:
    """
  ...
  def set_xmin_xmax(self, xmin: float | None = None, xmax: float | None = None) -> None:
    """
  ...
  def simulate(self, n: int, seeds: collections.abc.Sequence[int] = [], check_fitted: bool = True) -> ArrayLike:
    """
...
def pairs_copula_data(data: ArrayLike, main: str = '', cols: Optional[list[str]] = None, grid_size: int = 50, bins: int = 20, scatter_size: float = 6.0) -> tuple[Figure, Axes]:
  """
...
def wdm(x: ArrayLike, y: ArrayLike, method: str, weights: ArrayLike = ..., remove_missing: bool = True) -> float:
  """
